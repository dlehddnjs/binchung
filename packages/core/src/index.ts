...
export { mapStatToUiStatus, statsForUiStatus } from "./evcharger/mapStatToUiStatus.js";
export { chgerTypesForSpeed, classifyChargerSpeed } from "./evcharger/classifyChargerSpeed.js";
